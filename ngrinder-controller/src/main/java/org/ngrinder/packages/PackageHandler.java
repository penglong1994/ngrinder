...
import static org.ngrinder.common.util.CompressionUtils.addByteToTar;
...
public abstract class PackageHandler {
	...
	protected void cleanUpPackageDir(boolean all) {
	...
	public void addFileToPackage(TarArchiveOutputStream tarArchiveOutputStream, File file, String path) throws IOException {
		CompressionUtils.addFileToTar(tarArchiveOutputStream, file, getLibPath() + path);
	}
	...
	public void addConfigToPackage(TarArchiveOutputStream tarOutputStream, Map<String, Object> agentConfigParam) throws IOException {
		final String config = getConfigContent(agentConfigParam);
	 ...
	 */
	private String getConfigContent(Map<String, Object> values) {
